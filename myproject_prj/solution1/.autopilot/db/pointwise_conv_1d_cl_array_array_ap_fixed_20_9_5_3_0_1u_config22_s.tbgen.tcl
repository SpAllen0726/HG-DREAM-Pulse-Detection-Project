set moduleName pointwise_conv_1d_cl_array_array_ap_fixed_20_9_5_3_0_1u_config22_s
set isTopModule 0
...
set C_modelName {pointwise_conv_1d_cl<array,array<ap_fixed<20,9,5,3,0>,1u>,config22>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer14_out int 192 regular {fifo 0 volatile }  }
	{ layer15_out int 20 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer14_out", "interface" : "fifo", "bitwidth" : 192, "direction" : "READONLY"} , 
 	{ "Name" : "layer15_out", "interface" : "fifo", "bitwidth" : 20, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer14_out_num_data_valid sc_in sc_lv 8 signal 0 } 
	{ layer14_out_fifo_cap sc_in sc_lv 8 signal 0 } 
	{ layer14_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ layer14_out_read sc_out sc_logic 1 signal 0 } 
	{ layer15_out_din sc_out sc_lv 20 signal 1 } 
	{ layer15_out_num_data_valid sc_in sc_lv 8 signal 1 } 
	{ layer15_out_fifo_cap sc_in sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer15_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "layer15_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "pointwise_conv_1d_cl_array_array_ap_fixed_20_9_5_3_0_1u_config22_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer14_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "80", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer14_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer15_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "80", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_6ns_5ns_10_1_0_U649", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_6ns_5ns_10_1_0_U650", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	pointwise_conv_1d_cl_array_array_ap_fixed_20_9_5_3_0_1u_config22_s {
...
set Spec2ImplPortList { 
	layer14_out { ap_fifo {  { layer14_out_dout fifo_port_we 0 192 }  { layer14_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer14_out_fifo_cap fifo_update 0 8 }  { layer14_out_empty_n fifo_status 0 1 }  { layer14_out_read fifo_data 1 1 } } }
	layer15_out { ap_fifo {  { layer15_out_din fifo_port_we 1 20 }  { layer15_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer15_out_fifo_cap fifo_update 0 8 }  { layer15_out_full_n fifo_status 0 1 }  { layer15_out_write fifo_data 1 1 } } }
}
set moduleName pointwise_conv_1d_cl_array_array_ap_fixed_20_9_5_3_0_1u_config22_s
set isTopModule 0
set isCombinational 0
