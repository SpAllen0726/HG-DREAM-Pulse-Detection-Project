set moduleName hard_sigmoid_array_array_ap_ufixed_8_0_4_0_0_1u_hard_sigmoid_config17_s
set isTopModule 0
...
set C_modelName {hard_sigmoid<array,array<ap_ufixed<8,0,4,0,0>,1u>,hard_sigmoid_config17>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer15_out int 20 regular {fifo 0 volatile }  }
	{ layer17_out int 8 regular {axi_s 1 volatile  { layer17_out Data } }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer15_out", "interface" : "fifo", "bitwidth" : 20, "direction" : "READONLY"} , 
 	{ "Name" : "layer17_out", "interface" : "axis", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer15_out_dout sc_in sc_lv 20 signal 0 } 
	...
	{ layer17_out_TDATA sc_out sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer15_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "layer15_out", "role": "dout" }} , 
 	...
 	{ "name": "layer17_out_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "layer17_out", "role": "TDATA" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "hard_sigmoid_array_array_ap_ufixed_8_0_4_0_0_1u_hard_sigmoid_config17_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer15_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "80", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_layer17_out_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	hard_sigmoid_array_array_ap_ufixed_8_0_4_0_0_1u_hard_sigmoid_config17_s {
...
set Spec2ImplPortList { 
	layer15_out { ap_fifo {  { layer15_out_dout fifo_port_we 0 20 }  { layer15_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer15_out_fifo_cap fifo_update 0 8 }  { layer15_out_empty_n fifo_status 0 1 }  { layer15_out_read fifo_data 1 1 } } }
	layer17_out { axis {  { layer17_out_TREADY out_acc 0 1 }  { layer17_out_TDATA out_data 1 8 }  { layer17_out_TVALID out_vld 1 1 } } }
}
set moduleName hard_sigmoid_array_array_ap_ufixed_8_0_4_0_0_1u_hard_sigmoid_config17_s
set isTopModule 0
set isCombinational 0
