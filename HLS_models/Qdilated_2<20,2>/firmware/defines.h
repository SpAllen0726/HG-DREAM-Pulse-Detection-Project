...
typedef nnet::array<ap_fixed<20,2>, 2*1> layer2_t;
...
typedef nnet::array<ap_fixed<20,2>, 2*1> layer5_t;
...
typedef nnet::array<ap_fixed<20,2>, 2*1> layer8_t;
...
typedef nnet::array<ap_fixed<20,2>, 2*1> layer11_t;
...
typedef nnet::array<ap_fixed<20,2>, 1*1> layer21_t;
