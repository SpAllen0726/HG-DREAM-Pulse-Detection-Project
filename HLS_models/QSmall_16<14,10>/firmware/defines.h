...
typedef nnet::array<ap_fixed<14,10>, 1*1> layer14_t;
typedef ap_fixed<14,10> q_conv1d_20_accum_t;
...
typedef ap_fixed<14,10> q_conv1d_21_accum_t;
...
typedef ap_fixed<14,10> q_conv1d_22_accum_t;
...
typedef ap_fixed<14,10> q_conv1d_23_accum_t;
