...
typedef nnet::array<ap_fixed<20,4>, 2*1> layer2_t;
...
typedef nnet::array<ap_fixed<20,4>, 2*1> layer5_t;
...
typedef nnet::array<ap_fixed<20,4>, 2*1> layer8_t;
...
typedef nnet::array<ap_fixed<20,4>, 2*1> layer11_t;
...
typedef ap_fixed<20,4> q_conv1d_24_accum_t;
