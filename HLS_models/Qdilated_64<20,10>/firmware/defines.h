...
typedef ap_fixed<20,10> q_conv1d_15_accum_t;
typedef nnet::array<ap_fixed<20,10>, 64*1> layer2_t;
...
typedef nnet::array<ap_fixed<20,10>, 64*1> layer5_t;
...
typedef nnet::array<ap_fixed<20,10>, 64*1> layer8_t;
...
typedef nnet::array<ap_fixed<20,10>, 64*1> layer11_t;
