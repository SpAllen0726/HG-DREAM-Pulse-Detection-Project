...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight2_t, 3>(w2, "w2.txt");
        nnet::load_weights_from_txt<bias2_t, 1>(b2, "b2.txt");
        nnet::load_weights_from_txt<weight5_t, 3>(w5, "w5.txt");
        nnet::load_weights_from_txt<bias5_t, 1>(b5, "b5.txt");
        nnet::load_weights_from_txt<weight8_t, 3>(w8, "w8.txt");
        nnet::load_weights_from_txt<bias8_t, 1>(b8, "b8.txt");
        nnet::load_weights_from_txt<weight17_t, 1>(w17, "w17.txt");
    ...
    nnet::zeropad1d_cl<input_t, layer14_t, config14>(input_1, layer14_out); // zp1d_q_conv1d

    hls::stream<layer2_t> layer2_out("layer2_out");
    #pragma HLS STREAM variable=layer2_out depth=80
    nnet::conv_1d_cl<layer14_t, layer2_t, config2>(layer14_out, layer2_out, w2, b2); // q_conv1d
    ...
    nnet::zeropad1d_cl<layer4_t, layer15_t, config15>(layer4_out, layer15_out); // zp1d_q_conv1d_1

    hls::stream<layer5_t> layer5_out("layer5_out");
    #pragma HLS STREAM variable=layer5_out depth=80
    nnet::conv_1d_cl<layer15_t, layer5_t, config5>(layer15_out, layer5_out, w5, b5); // q_conv1d_1
    ...
    nnet::zeropad1d_cl<layer7_t, layer16_t, config16>(layer7_out, layer16_out); // zp1d_q_conv1d_2

    hls::stream<layer8_t> layer8_out("layer8_out");
    #pragma HLS STREAM variable=layer8_out depth=80
    nnet::conv_1d_cl<layer16_t, layer8_t, config8>(layer16_out, layer8_out, w8, b8); // q_conv1d_2
    ...
    nnet::pointwise_conv_1d_cl<layer10_t, layer17_t, config17>(layer10_out, layer17_out, w17, b17); // q_conv1d_3

    nnet::hard_sigmoid<layer17_t, result_t, hard_sigmoid_config13>(layer17_out, layer13_out); // q_activation_3
