...
typedef ap_fixed<12,10> q_conv1d_accum_t;
typedef nnet::array<ap_fixed<12,10>, 16*1> layer2_t;
...
typedef ap_fixed<12,10> q_conv1d_1_accum_t;
typedef nnet::array<ap_fixed<12,10>, 16*1> layer5_t;
...
typedef ap_fixed<12,10> q_conv1d_2_accum_t;
typedef nnet::array<ap_fixed<12,10>, 16*1> layer8_t;
...
typedef ap_fixed<12,10> q_conv1d_3_accum_t;
typedef nnet::array<ap_fixed<12,10>, 16*1> layer11_t;
...
typedef ap_fixed<12,10> q_conv1d_4_accum_t;
