...
struct config2_mult : nnet::dense_config {
    ...
    typedef conv1d_13_accum_t accum_t;
    typedef conv1d_13_bias_t bias_t;
    typedef conv1d_13_weight_t weight_t;
...
struct config5_mult : nnet::dense_config {
    ...
    static const unsigned n_zeros = 0;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef conv1d_14_accum_t accum_t;
    typedef conv1d_14_bias_t bias_t;
    typedef conv1d_14_weight_t weight_t;
    template<class x_T, class y_T>
    using product = nnet::product::mult<x_T, y_T>;
};
...
struct config8_mult : nnet::dense_config {
    ...
    static const unsigned n_zeros = 0;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef conv1d_15_accum_t accum_t;
...
struct config17_mult : nnet::dense_config {
    ...
    static const unsigned n_zeros = 0;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef conv1d_16_accum_t accum_t;
