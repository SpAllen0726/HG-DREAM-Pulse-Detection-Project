...
typedef ap_fixed<16,6> q_conv1d_65_accum_t;
typedef nnet::array<ap_fixed<16,6>, 16*1> layer3_t;
...
typedef ap_fixed<16,6> q_conv1d_66_accum_t;
...
typedef ap_fixed<16,6> q_conv1d_67_accum_t;
...
typedef ap_fixed<16,6> q_conv1d_68_accum_t;
...
typedef ap_fixed<16,6> q_conv1d_69_accum_t;
