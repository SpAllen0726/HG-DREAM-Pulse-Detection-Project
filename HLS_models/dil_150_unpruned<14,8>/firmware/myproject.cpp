...
void myproject(
    ...
    #pragma HLS INTERFACE axis port=input_2,layer16_out 
    #pragma HLS DATAFLOW 
    ...
    nnet::zeropad1d_cl<input_t, layer17_t, config17>(input_2, layer17_out); // zp1d_q_conv1d_5

    hls::stream<layer2_t> layer2_out("layer2_out");
    #pragma HLS STREAM variable=layer2_out depth=80
    nnet::conv_1d_cl<layer17_t, layer2_t, config2>(layer17_out, layer2_out, w2, b2); // q_conv1d_5

    hls::stream<layer4_t> layer4_out("layer4_out");
    #pragma HLS STREAM variable=layer4_out depth=80
    nnet::relu<layer2_t, layer4_t, relu_config4>(layer2_out, layer4_out); // q_activation_5

    hls::stream<layer18_t> layer18_out("layer18_out");
    #pragma HLS STREAM variable=layer18_out depth=82
    nnet::zeropad1d_cl<layer4_t, layer18_t, config18>(layer4_out, layer18_out); // zp1d_q_conv1d_6

    hls::stream<layer5_t> layer5_out("layer5_out");
    #pragma HLS STREAM variable=layer5_out depth=80
    nnet::conv_1d_cl<layer18_t, layer5_t, config5>(layer18_out, layer5_out, w5, b5); // q_conv1d_6

    hls::stream<layer7_t> layer7_out("layer7_out");
    #pragma HLS STREAM variable=layer7_out depth=80
    nnet::relu<layer5_t, layer7_t, relu_config7>(layer5_out, layer7_out); // q_activation_6

    hls::stream<layer19_t> layer19_out("layer19_out");
    #pragma HLS STREAM variable=layer19_out depth=82
    nnet::zeropad1d_cl<layer7_t, layer19_t, config19>(layer7_out, layer19_out); // zp1d_q_conv1d_7

    hls::stream<layer8_t> layer8_out("layer8_out");
    #pragma HLS STREAM variable=layer8_out depth=80
    nnet::conv_1d_cl<layer19_t, layer8_t, config8>(layer19_out, layer8_out, w8, b8); // q_conv1d_7

    hls::stream<layer10_t> layer10_out("layer10_out");
    #pragma HLS STREAM variable=layer10_out depth=80
    nnet::relu<layer8_t, layer10_t, relu_config10>(layer8_out, layer10_out); // q_activation_7

    hls::stream<layer20_t> layer20_out("layer20_out");
    #pragma HLS STREAM variable=layer20_out depth=82
    nnet::zeropad1d_cl<layer10_t, layer20_t, config20>(layer10_out, layer20_out); // zp1d_q_conv1d_8

    hls::stream<layer11_t> layer11_out("layer11_out");
    #pragma HLS STREAM variable=layer11_out depth=80
    nnet::conv_1d_cl<layer20_t, layer11_t, config11>(layer20_out, layer11_out, w11, b11); // q_conv1d_8

    hls::stream<layer13_t> layer13_out("layer13_out");
    #pragma HLS STREAM variable=layer13_out depth=80
    nnet::relu<layer11_t, layer13_t, relu_config13>(layer11_out, layer13_out); // q_activation_8

    hls::stream<layer21_t> layer21_out("layer21_out");
    #pragma HLS STREAM variable=layer21_out depth=80
    nnet::pointwise_conv_1d_cl<layer13_t, layer21_t, config21>(layer13_out, layer21_out, w21, b21); // q_conv1d_9

    nnet::hard_sigmoid<layer21_t, result_t, hard_sigmoid_config16>(layer21_out, layer16_out); // q_activation_9
