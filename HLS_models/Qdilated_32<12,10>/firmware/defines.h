...
typedef ap_fixed<12,10> q_conv1d_10_accum_t;
typedef nnet::array<ap_fixed<12,10>, 32*1> layer2_t;
...
typedef ap_fixed<12,10> q_conv1d_11_accum_t;
typedef nnet::array<ap_fixed<12,10>, 32*1> layer5_t;
...
typedef ap_fixed<12,10> q_conv1d_12_accum_t;
typedef nnet::array<ap_fixed<12,10>, 32*1> layer8_t;
...
typedef ap_fixed<12,10> q_conv1d_13_accum_t;
typedef nnet::array<ap_fixed<12,10>, 32*1> layer11_t;
...
typedef ap_fixed<12,10> q_conv1d_14_accum_t;
