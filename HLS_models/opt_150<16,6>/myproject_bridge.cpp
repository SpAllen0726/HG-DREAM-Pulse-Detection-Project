...
void myproject_float(
    ...
    float layer17_out[N_OUTPUTS_15*N_FILT_15]
) {
    ...
    myproject(input_1_ap,layer17_out_ap);

    nnet::convert_data<result_t, float, N_OUTPUTS_15*N_FILT_15>(layer17_out_ap, layer17_out);
}

void myproject_double(
    double input_1[N_INPUT_1_1*N_INPUT_2_1],
    double layer17_out[N_OUTPUTS_15*N_FILT_15]
) {
    hls::stream<input_t> input_1_ap("input_1");
    ...
    nnet::convert_data<result_t, double, N_OUTPUTS_15*N_FILT_15>(layer17_out_ap, layer17_out);
}
}
