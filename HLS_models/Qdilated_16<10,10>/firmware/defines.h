...
typedef nnet::array<ap_fixed<10,10>, 1*1> input_t;
typedef nnet::array<ap_fixed<10,10>, 1*1> layer17_t;
typedef ap_fixed<10,10> q_conv1d_accum_t;
typedef nnet::array<ap_fixed<10,10>, 16*1> layer2_t;
...
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT>, 16*1> layer18_t;
typedef ap_fixed<10,10> q_conv1d_1_accum_t;
typedef nnet::array<ap_fixed<10,10>, 16*1> layer5_t;
typedef ap_fixed<8,3> weight5_t;
typedef ap_fixed<8,3> bias5_t;
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT>, 16*1> layer7_t;
typedef ap_fixed<18,8> q_activation_1_table_t;
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT>, 16*1> layer19_t;
typedef ap_fixed<10,10> q_conv1d_2_accum_t;
typedef nnet::array<ap_fixed<10,10>, 16*1> layer8_t;
...
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT>, 16*1> layer20_t;
typedef ap_fixed<10,10> q_conv1d_3_accum_t;
typedef nnet::array<ap_fixed<10,10>, 16*1> layer11_t;
...
typedef ap_fixed<10,10> q_conv1d_4_accum_t;
typedef nnet::array<ap_fixed<10,10>, 1*1> layer21_t;
