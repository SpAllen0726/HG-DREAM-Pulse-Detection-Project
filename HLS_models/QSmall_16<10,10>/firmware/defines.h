...
typedef nnet::array<ap_fixed<10,10>, 1*1> layer14_t;
typedef ap_fixed<10,10> q_conv1d_20_accum_t;
...
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT>, 16*1> layer15_t;
typedef ap_fixed<10,10> q_conv1d_21_accum_t;
...
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT>, 16*1> layer16_t;
typedef ap_fixed<10,10> q_conv1d_22_accum_t;
...
typedef ap_fixed<10,10> q_conv1d_23_accum_t;
