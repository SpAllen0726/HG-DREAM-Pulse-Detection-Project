...
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT>, 4*1> layer15_t;
...
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT>, 4*1> layer7_t;
typedef ap_fixed<18,8> q_activation_1_table_t;
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT>, 4*1> layer16_t;
...
typedef nnet::array<ap_ufixed<6,0,AP_RND_CONV,AP_SAT>, 4*1> layer10_t;
