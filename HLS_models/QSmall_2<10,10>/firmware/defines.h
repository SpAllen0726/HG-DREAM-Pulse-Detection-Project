...
typedef nnet::array<ap_fixed<10,10>, 2*1> layer2_t;
...
typedef ap_fixed<10,10> q_conv1d_5_accum_t;
typedef nnet::array<ap_fixed<10,10>, 2*1> layer5_t;
...
typedef ap_fixed<10,10> q_conv1d_6_accum_t;
typedef nnet::array<ap_fixed<10,10>, 2*1> layer8_t;
...
typedef ap_fixed<10,10> q_conv1d_7_accum_t;
