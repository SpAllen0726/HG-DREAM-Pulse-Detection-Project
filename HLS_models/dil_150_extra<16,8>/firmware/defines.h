...
typedef nnet::array<ap_fixed<16,8>, 1*1> layer20_t;
typedef ap_fixed<16,8> q_conv1d_17_accum_t;
...
typedef ap_fixed<16,8> q_conv1d_18_accum_t;
...
typedef ap_fixed<16,8> q_conv1d_19_accum_t;
typedef nnet::array<ap_fixed<16,8>, 32*1> layer8_t;
...
typedef nnet::array<ap_fixed<16,8>, 32*1> layer11_t;
...
typedef nnet::array<ap_fixed<16,8>, 32*1> layer14_t;
...
typedef nnet::array<ap_fixed<16,8>, 1*1> layer25_t;
