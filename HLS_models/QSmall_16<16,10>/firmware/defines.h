...
typedef ap_fixed<16,10> q_conv1d_20_accum_t;
typedef nnet::array<ap_fixed<16,10>, 16*1> layer2_t;
...
typedef ap_fixed<16,10> q_conv1d_21_accum_t;
typedef nnet::array<ap_fixed<16,10>, 16*1> layer5_t;
...
typedef ap_fixed<16,10> q_conv1d_22_accum_t;
typedef nnet::array<ap_fixed<16,10>, 16*1> layer8_t;
...
typedef ap_fixed<16,10> q_conv1d_23_accum_t;
