...
typedef ap_fixed<20,10> q_conv1d_16_accum_t;
...
typedef ap_fixed<20,10> q_conv1d_17_accum_t;
typedef nnet::array<ap_fixed<20,10>, 8*1> layer5_t;
...
typedef ap_fixed<20,10> q_conv1d_18_accum_t;
typedef nnet::array<ap_fixed<20,10>, 8*1> layer8_t;
...
typedef ap_fixed<20,10> q_conv1d_19_accum_t;
