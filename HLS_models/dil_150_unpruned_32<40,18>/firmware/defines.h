...
typedef nnet::array<ap_fixed<40,18>, 1*1> input_t;
typedef nnet::array<ap_fixed<40,18>, 1*1> layer17_t;
typedef ap_fixed<40,18> q_conv1d_5_accum_t;
typedef nnet::array<ap_fixed<40,18>, 32*1> layer2_t;
...
typedef ap_fixed<40,18> q_conv1d_6_accum_t;
typedef nnet::array<ap_fixed<40,18>, 32*1> layer5_t;
...
typedef ap_fixed<40,18> q_conv1d_7_accum_t;
typedef nnet::array<ap_fixed<40,18>, 32*1> layer8_t;
...
typedef ap_fixed<40,18> q_conv1d_8_accum_t;
typedef nnet::array<ap_fixed<40,18>, 32*1> layer11_t;
...
typedef ap_fixed<40,18> q_conv1d_9_accum_t;
typedef nnet::array<ap_fixed<40,18>, 1*1> layer21_t;
