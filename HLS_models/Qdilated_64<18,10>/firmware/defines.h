...
typedef ap_fixed<18,10> q_conv1d_15_accum_t;
typedef nnet::array<ap_fixed<18,10>, 64*1> layer2_t;
...
typedef ap_fixed<18,10> q_conv1d_16_accum_t;
typedef nnet::array<ap_fixed<18,10>, 64*1> layer5_t;
...
typedef ap_fixed<18,10> q_conv1d_17_accum_t;
typedef nnet::array<ap_fixed<18,10>, 64*1> layer8_t;
...
typedef ap_fixed<18,10> q_conv1d_18_accum_t;
typedef nnet::array<ap_fixed<18,10>, 64*1> layer11_t;
...
typedef ap_fixed<18,10> q_conv1d_19_accum_t;
