...
struct config2_mult : nnet::dense_config {
    ...
    typedef q_conv1d_10_accum_t accum_t;
...
struct config5_mult : nnet::dense_config {
    ...
    static const unsigned reuse_factor = 1;
    static const unsigned strategy = nnet::latency;
    static const unsigned n_zeros = 261;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef q_conv1d_11_accum_t accum_t;
...
struct config8_mult : nnet::dense_config {
    ...
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef q_conv1d_12_accum_t accum_t;
...
struct config11_mult : nnet::dense_config {
    ...
    static const unsigned reuse_factor = 1;
    static const unsigned strategy = nnet::latency;
    static const unsigned n_zeros = 253;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef q_conv1d_13_accum_t accum_t;
...
struct config21_mult : nnet::dense_config {
    ...
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef q_conv1d_14_accum_t accum_t;
...
const slope16_t hard_sigmoid_config16::slope = 0.5;
const shift16_t hard_sigmoid_config16::shift = 0.5;
