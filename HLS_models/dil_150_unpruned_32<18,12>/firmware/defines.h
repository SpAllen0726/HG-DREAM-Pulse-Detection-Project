...
typedef ap_fixed<18,12> q_conv1d_5_accum_t;
...
typedef ap_fixed<18,12> q_conv1d_6_accum_t;
...
typedef ap_fixed<18,12> q_conv1d_7_accum_t;
...
typedef ap_fixed<18,12> q_conv1d_8_accum_t;
...
typedef ap_fixed<18,12> q_conv1d_9_accum_t;
