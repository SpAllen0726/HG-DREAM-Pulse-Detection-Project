...
typedef nnet::array<ap_fixed<18,12>, 16*1> layer2_t;
...
typedef nnet::array<ap_fixed<18,12>, 16*1> layer5_t;
...
typedef nnet::array<ap_fixed<18,12>, 16*1> layer8_t;
...
typedef nnet::array<ap_fixed<18,12>, 16*1> layer11_t;
