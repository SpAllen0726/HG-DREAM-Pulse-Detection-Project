...
set C_modelArgList {
	{ layer5_out int 704 regular {fifo 0 volatile }  }
	{ layer7_out int 192 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer5_out", "interface" : "fifo", "bitwidth" : 704, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer5_out_dout sc_in sc_lv 704 signal 0 } 
	{ layer5_out_num_data_valid sc_in sc_lv 7 signal 0 } 
	{ layer5_out_fifo_cap sc_in sc_lv 7 signal 0 } 
	...
	{ layer7_out_num_data_valid sc_in sc_lv 7 signal 1 } 
	{ layer7_out_fifo_cap sc_in sc_lv 7 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer5_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":704, "type": "signal", "bundle":{"name": "layer5_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer5_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "40", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer5_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer7_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "40", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer5_out { ap_fifo {  { layer5_out_dout fifo_port_we 0 704 }  { layer5_out_num_data_valid fifo_status_num_data_valid 0 7 }  { layer5_out_fifo_cap fifo_update 0 7 }  { layer5_out_empty_n fifo_status 0 1 }  { layer5_out_read fifo_data 1 1 } } }
	layer7_out { ap_fifo {  { layer7_out_din fifo_port_we 1 192 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 7 }  { layer7_out_fifo_cap fifo_update 0 7 }  { layer7_out_full_n fifo_status 0 1 }  { layer7_out_write fifo_data 1 1 } } }
}
set moduleName relu_array_ap_fixed_32u_array_ap_ufixed_6_0_4_0_0_32u_relu_config7_s
set isTopModule 0
set isCombinational 0
