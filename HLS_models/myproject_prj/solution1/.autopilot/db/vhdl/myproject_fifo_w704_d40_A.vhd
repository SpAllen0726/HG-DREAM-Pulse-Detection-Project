...
entity myproject_fifo_w704_d40_A is
    generic (
        MEM_STYLE         : string  := "auto";
        DATA_WIDTH        : integer := 704;
...
architecture arch of myproject_fifo_w704_d40_A is

    -- component
    component myproject_fifo_w704_d40_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
        DATA_WIDTH : natural := 704;
...
begin
----------------------- Instantiation -----------------------
    U_myproject_fifo_w704_d40_A_ram : myproject_fifo_w704_d40_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity myproject_fifo_w704_d40_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 704;
        ADDR_WIDTH  : integer := 6;
...
architecture arch of myproject_fifo_w704_d40_A_ram is
